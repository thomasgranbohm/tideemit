/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 937a2476fbfa2ac21259e5117d24b157)
// Runtime types generated with workerd@1.20260114.0 2026-01-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		NEXT_PUBLIC_URL: "https://www.tideemit.net";
		TIMEZONE: "Europe/Stockholm";
		URL: "https://www.tideemit.net";
		NEXTJS_ENV: string;
		DATABASE: D1Database;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_URL" | "TIMEZONE" | "URL" | "NEXTJS_ENV">> {}
}
